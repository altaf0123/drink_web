                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                <?php if($data->account_status == 'active'): ?>
                                    <a href='{{ url("manager/users/toComplete") }}/{{ $data->id }}' ><span class="badge badge-success">Active</span></a>
                                <?php else: ?>
                                    <a href='{{ url("manager/users/toPending") }}/{{ $data->id }}' ><span class="badge badge-danger">Inactive</span></a>
                                <?php endif; ?>
                            </td>
                            <td class="text-center">
                                <?php if($data->account_verified == 1): ?>
                                    <a href='{{ url("manager/users/toVerifyPending") }}/{{ $data->id }}' ><span class="swalDefaultSuccess badge badge-success">Verified</span></a>
                                <?php else: ?>
                                    <a href='{{ url("manager/users/toVerifyComplete") }}/{{ $data->id }}' ><span class="swalDefaultSuccess badge badge-danger">Unverified</span></a>
                                <?php endif; ?>
                            </td>
