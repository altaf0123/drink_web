...
<div class="container-fluid">
  <div class="row mb-2">
   ...
   <!--<a class="btn btn-primary mt-3" href="{{ url('manager/products/add') }}" >Add New Product</a>-->

    </div>
    <div class="col-sm-5">
        <form class="form-inline" action="{{ url('manager/products/search') }}" method="GET" style="max-width:65%;float:right;">
          ...
          <table class="table mb-5" width="100%">
                  ...
                  <tbody>
                      ...
                      <tr>
                          ...
                          <a href="{{ url('manager/products/view') }}/{{ $data->id }}" >{{ $data->name }}</a>
                          @else
