...
<div class="col-lg-6">
    ...
    <!-- /.card-header -->
                <div class="card-body">
                    <form class="form-horizontal form-label-left" method="POST" action="{{ url('admin/reservations/add') }}"
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control float-right" name="times" id="reservationtime" required>
                            </div>
                        </div>
                        <div class="form-group">
                            <label>Status *</label>
