          ...
          <table class="table mb-5" width="100%">
                  ...
                  <tbody>
                      ...
                      <tr>
                        ...
                        <td><a href='{{ url("admin/waiters/assign") }}/{{$data->id}}' >{{ $data->name }}</a></td>
                        <td class="text-center">
                            <?= $data->restaurant_id == "" ? '<span style="color:orange;" >Not assigned</span>' : ucwords(getRestaurantName($data->restaurant_id)); ?>
                        </td>
                      </tr>
                      @endforeach
                  </tbody>
