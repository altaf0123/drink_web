         ...
         <div class="row">
            <div class="col-lg-6">
               <div class="card">
                  <!-- /.card-header -->
                  <div class="card-body">
                     <form class="form-horizontal form-label-left" method="POST" action="{{ url('admin/tables/update') }}/{{$records->id}}"
                        ...
                        <div class="form-group" >
                            ...
                            <select name="status" class="form-control">
                                <option value="1" <?= $records->restaurant_id == 1 ? 'selected' : '' ?>>Active</option>
                                <option value="2" <?= $records->restaurant_id == 2 ? 'selected' : '' ?>>Inactive</option>
                            </select>
                        </div>
