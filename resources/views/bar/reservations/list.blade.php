...
<div class="container-fluid">
  <div class="row mb-2">
    ...
    <a class="btn btn-primary mt-3" href="{{ url('user/reservations/add') }}" >Add New</a>
          ...
          <table class="table mb-5" width="100%">
                  ...
                  <tbody>
                      ...
                      <tr>
                          ...
                          $data->tr_status == 'confirmed' 
                          ? '<span class="badge badge-success">Confirmed</span>' 
                          : '<span class="badge badge-danger">Not Confirmed</span>'; ?></td>
                          <td class="text-center">{{ $data->price }}</td>
                          <td class="project-actions text-right">
                            <a class="btn btn-danger btn-sm" href="{{ url('user/reservations/delete') }}/{{$data->id}}">
                                <i class="fas fa-trash">
                                </i>
                            </a>
                            <a class="btn btn-warning btn-sm" href="{{ url('user/reservations/show') }}/{{$data->id}}">
                                <i class="fas fa-edit">
                                </i>
                            </a>
                        </td>
