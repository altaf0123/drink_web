...
<a  href="{{ url('user/products') }}" class="btn btn-primary mt-3">Back to List</a>
...
<div class="col-lg-6">
    ...
    <!-- /.card-header -->
                <div class="card-body">
                    <form class="form-horizontal form-label-left" method="POST" action="{{ url('user/products/update') }}/{{$records->id}}"
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" name="type" required>
                                ...
                                <option value="{{ $row->types_name }}" <?= $records->type == $row->types_name ? 'selected' : ''; ?>>{{ $row->types_name }}</option>
                                @endforeach
                            </select>
                        </div>
                        <div class="form-group">
