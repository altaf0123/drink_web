...
<div class="col-lg-6">
    ...
    <!-- /.card-header -->
                <div class="card-body">
                    <form class="form-horizontal form-label-left" method="POST" action="{{ url('user/products/add') }}"
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="price" placeholder="Unit Price" maxlength="15">
                        </div>
                        <div class="form-group">
