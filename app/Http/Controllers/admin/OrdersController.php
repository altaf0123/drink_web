...
class OrdersController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('admin.orders.list')->with('records', $ord);
    }
    ...
    public function show($id)
    {
        ...
        return view('admin.orders.show')->with('records', $viewOrder);
    }
    ...
    public static function search(Request $request)
    {
        if (isset($_GET['query'])) {
            ...
            return view('admin.orders.list', ['records' => $orders, 'search_type' => $request->input('search_type')]);
        } else {
